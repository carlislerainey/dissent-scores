---
title: "Compute Dissent Scores Using ICEWS Source Data"
freeze: true
---
...
round(as.numeric(draws[1, 1]), 5) == -5.38761
...
dissent_scores <- draws %>% 
  ...
  # add version info
  mutate(release = "V0.0.9999", 
         release_date = "2023-09-13", 
         created_date = Sys.Date()) %>%
  # select variables for final data set
  select(release, release_date, country_name, ccode, stateabb, year, n_events, n_dissent_events, frac_dissent_events, avg_pi, avg_eta, dissent_score, se_dissent_score)
